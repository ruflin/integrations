...
func renderExportedFields(packageDataset string, datastreams datasetContentArray) (string, error) {
	for _, datastream := range datastreams {
		if packageDataset == datastream.dataset {
	...
	return "", fmt.Errorf("missing datastream: %s", packageDataset)
}
